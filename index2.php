...
<head>
  ...
  <title>MiniShop.Com-Index</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage">MiniShop.com</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <?php
              ...
              $id=$row['mem_id'];
              ?>
<li><a href="" style="color: #ffffff;">Hi:<?php echo $row ['email']; ?></a></li>
      <li class="dropdown">
...
<div id="tour" class="bg-1">
  <div class="container">
    ...
    <p class="text-center">MiniShop .<br>
...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span>MiniShop, U.P></p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +91 914546801/0914546801</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: contact@minishop.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
...
<footer class="text-center">
 ...
 © 2022 AllRight Reserved MiniShop.com
</p> 
</footer>
