...
if (isset($_POST['register'])) {
  ...
  $saved=$connection->InsertData($_POST['firstname'],$_POST['lastname'],$_POST['mobilenumber'],$_POST['email'],$_POST['password'],$_POST['profile']);
  if ($saved) {
...
<html>
<head>
	<title>Minishop-Registration-Form</title>
    ...
    <div class="col-sm-5" style="float:left;margin-top:0px; margin-left: 100px;">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <a href="../index.php"><h3 style="color: #fff;">Minishop.com</h3></a>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="Last Name" id="usr" name="lastname" required="" />
             ...
             <div class="form-group">
           <label for="usr" class="text">MobileNumber:-</label>
            <input type="text" class="form-control" id="usr"  placeholder="MobileNumber " name="mobilenumber" required=""> 
            </div><br><br>
          <div class="form-group">
