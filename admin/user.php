 ...
 <div class="container-fluid" style="max-width: 95%;">
  <div class="row">
    <div class="col-sm-2" style="background-color:#e3e3e3;">
      <p style="color: #428bca;font-weight: bolder;margin-left: 30px;">Wellcom:<?php echo $row ['mobilenumber']; ?></p>
      ...
      <div>
        <form method="post" action="" style="border-style: double;border: solid #000;">
          ...
          <div class="form-group">
            ...
            <input id="usr" class="form-control" type="text" name="mobilenumber" value="<?php echo $row ['mobilenumber'];?>">
