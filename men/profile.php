  ...
  ?>          
              ...
              <form method="post" action="" style="max-width: 50%;margin-left: 30%" >
                <label style="margin-left:10px;color:#000;" >Update Information</label><br>
                 <span style="color: #428bca;text-align: center;margin-left:30px;">Mobile Number:-
                <input type="text" name="mobilenumber" value="<?php echo $row['mobilenumber'];?>" style="border-radius: 360px;" class="form-control">
              </span>
