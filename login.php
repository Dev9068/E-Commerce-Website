...
$login_query=mysqli_query($conn,"select * from member where mobilenumber='$mobilenumber' and password='$password'");
...
header("Location:index2.php?status=sucsses&msg=sucsses Full Login");
   ...
   header("Location: login.php?status=error&msg=Mobile Number Or Password Incorrect");
if (!empty($mobilenumber) or !empty($password)) {
    $crud->login($mobilenumber,$password);
  }else{
...
<html>
<head>
  <title>MiniShope-login-Form</title>
    ...
    <div class="col-sm-5" style="margin-top:50px; float:left;left:100px;">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <a href=""><h3 style="color: #fff;">minishop.com</h3></a><br>
          <h4>Login Form</h4>
       ...
       <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal" method="post">
          <fieldset>
            ...
            <div class="input-group input-group-lg" style="width:100%;">
              ...
              <input type="text" id="usr" name="mobilenumber" placeholder="Mobile Number" class="form-control">
            </div>
